...
public class Employee {
	...
	public static void main(String[] args) {
		...
		List<Employee>	sortedList = list.stream()
				.sorted((Employee e1, Employee e2) ->{int nameComp = e1.getName().compareTo(e2.getName());
					return (nameComp != 0) ? nameComp : Double.compare(e1.getSalary(), e2.getSalary()) * -1;})
								//((e1.getName().compareTo(e2.getName()) != 0)? e1.getName().compareTo(e2.getName()) : Double.compare(e1.getSalary(), e2.getSalary()) * -1))
